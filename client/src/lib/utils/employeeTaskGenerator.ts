  ...
  if (employee.visaExpiryDate || employee.visaType) {
    ...
    if (!taskExists(uniqueKey)) {
      generatedTasks.push({
        ...
        taskType: "keep_visa_copy_initial",
        dueAt: dueDate.toISO() || dueDate.toUTC().toISO() || new Date().toISOString(),
        priority: "high",
        uniqueKey,
      });
