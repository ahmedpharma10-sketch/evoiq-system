...
export const completeEmployeeRecordSchema = insertEmployeeRecordSchema.extend({
  ...
  if (data.isDraft === false || data.isDraft === undefined) {
    ...
    if (data.immigrationStatus in ['british', 'settled'] && !data.rtwExpiryIndefinite) {
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
...
export const employees = pgTable("employees", {
  ...
  personalMobile: varchar("personal_mobile").notNull(),
  ...
  overseasAddress: text("overseas_address").notNull(),
  ...
  immigrationStatus: varchar("immigration_status").notNull(),
